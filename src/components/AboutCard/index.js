    ...
    <div className="container">
      <div className="card nes-container with-title is-centered mb-5">
        <p className="title nes-container">About</p>
          ...
          <img className="img-responsive float-left mb-3" width="250px" height="260px" src={headshot} alt="Headshot"></img>
          ...
          <p>For so long, I have wanted to learn to code, and now that dream is a reality. I recently received a certificate in Full-Stack Web Development through the University of Washington, and I am ready to start building the next great web app!</p>
          </div>
      </div>
    </div>
  );
